...
export default function Steps(){
    ...
    <>
        ...
        <h1 className="text-4xl md:text-6xl font-bold text-slate-100 text-center">Ready to create 100+ new avatars?</h1>
            ...
            <b className="p-10 text-cyan-500">If you use iPhone before taking photos go to Settings &gt; Camera &gt; Format and select Most Compatible to save your photos in JPEG.</b>
